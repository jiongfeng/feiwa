...
<div class="public-top-layout w">
  <div class="topbar warp-all">
    <div class="user-entry">
      ...
      <?php }else{?>
      <?php echo $lang['feiwa_hello'].$lang['feiwa_comma'].$lang['welcome_to_site'];?> <a href="<?php echo MALL_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a> <span>[<a href="<?php echo urlMall('login');?>"><?php echo $lang['feiwa_login'];?></a>]</span> <span>[<a href="<?php echo urlMall('login','register');?>"><?php echo $lang['feiwa_register'];?></a>]</span>
      <?php }?>
    </div>
